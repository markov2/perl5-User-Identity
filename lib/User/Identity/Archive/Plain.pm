...
=warning option 'only' specifies undefined abbreviation '$abbrev'.
=cut
...
=fault cannot read archive from file $file: $!
=error cannot read archive from a $type.
=info  reading archive data from $source.
=cut
